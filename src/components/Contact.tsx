      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-12 animate-fade-in">
            I'm available for new projects on Freelancer.com. Reach me on Telegram, Discord, or WhatsApp.
          </p>
            ...
            {contactLinks.map((item, index) => {
              ...
              return (
                <a
                  ...
                  className="bg-card p-8 rounded-xl shadow-lg hover-lift animate-fade-in-up border border-border/50 flex flex-col items-center gap-4 transition-colors hover:border-primary/30"
